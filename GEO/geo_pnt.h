...
extern double AngleSumPointInsideTriangle(double* point, double* tri_p1, double* tri_p2, double* tri_p3,
                                          double tolerance);
 ...
 * */
CGLPoint* isPointInPointVector(const std::vector<CGLPoint*>& vec, const CGLPoint* const p, double tol = 1e-3);
