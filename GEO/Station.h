 ...
 * Variables of Station and derived classes can be defined to be "properties" of this class (this is entirely
 *optional!).
...
public:
	...
	/// Determines if the station's parameters are within the the bounds of the current selection (see property system
	/// for details)
	bool inSelection(const std::vector<PropertyBounds>& bounds);

	/// Returns true if all properties of this stations are within the boundaries given by \param bounds and false
	/// otherwise
...
protected:
	 ...
	 * \param stnObject A pointer to the station object for which the x-coordinate should be returned, usually
	 *(void*)this will work fine.
...
public:
	...
	static StationBorehole* createStation(const std::string& name, double x, double y, double z, double depth,
	                                      std::string date = "");

	/// Adds a stratigraphy to a borehole given a vector of points of length "n" and a vector of soil names of length
	/// "n-1".
	...
	/// Returns a reference to a vector of Points representing the stratigraphy of the borehole (incl. the station-point
	/// itself)
...
protected:
	/// Returns the depth of this borehole. Please see the documentation for Station::getX for details concerning the
	/// syntax.
	...
	/// Returns the date this borehole has been drilled. Please see the documentation for Station::getX for details
	...
	/// Sets the depth of this borehole. Please see the documentation for Station::getX for details concerning the
	/// syntax.
	...
	/// Sets the date when this borehole has been drilled. Please see the documentation for Station::getX for details
	/// concerning the syntax.
