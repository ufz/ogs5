...
{
template <class T>
void writeCompressedStorageFmt(std::ostream& os, unsigned n, unsigned* iA,
                               unsigned* jA, T* A)
{
...
template <class T>
void readCompressedStorageFmt(std::istream& is, unsigned& n, unsigned*& iA,
                              unsigned*& jA, T*& A)
{
    ...
    if (i < iA[n])
        std::cerr << "\n"
                  ...
                  << jA[i] << ", which is out of bounds."
                  << "\n";
#endif
}

template <class T>
void readCompressedStorageFmt(std::istream& is, long& n, long*& iA, long*& jA,
                              T*& A, T*& rhs)
{
