...
/* Method */
	void eqbrm(int N, int M, double **V, double *B, double **G, double *LOGK, double *Z, double *A, double *GAMMA, double &AW);
	void eqbrm_multiphases(int N, int M, double **V, double *B, double **G, double *LOGK, double *VW, double *Z, int *P, double *A, double *GAMMA, double &AW);
