...
public:
	 ...
	 */
	void getTopMeshNodesAlongPolylineAsPoints(const GEOLIB::Polyline& polyline,
	 ...
	 */
	void getPolygonFromPolyline(const GEOLIB::Polyline& polyline, GEOLIB::GEOObjects* geo_obj, std::string const& name,
	 ...
	 */
	void getProjectedPolylineFromPolyline(GEOLIB::Polyline const& ply_in, GEOLIB::GEOObjects* geo_obj,
	                                      std::string const& name, GEOLIB::Polyline*& ply_out, size_t layer = 0) const;
	 ...
	 */
	void getMeshNodeIDsWithinPolygon(GEOLIB::Polygon const& polygon, std::vector<size_t>& node_ids) const;
...
private:
	 ...
	 */
	void getOrthogonalProjectedMeshNodesAlongPolyline(GEOLIB::Polyline const& polyline,
