...
void CreateEQS_LinearSolver()
{
	...
	for (i = 0; i < npcs; i++)
	{
		...
		if ((pcs_type == DEFORMATION_H2) || (pcs_type == DEFORMATION_FLOW) || (pcs_type == DEFORMATION_DYNAMIC)
		    || (pcs_type == DEFORMATION))
		{
			...
			else if ((pcs_type == DEFORMATION_FLOW) || (pcs_type == DEFORMATION_DYNAMIC))
				eqs_dim += nn;
		...
		else if ((pcs_type == MULTI_PHASE_FLOW) || (pcs_type == TWO_PHASE_FLOW) || (pcs_type == PS_GLOBAL))
		{
