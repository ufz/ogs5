...
ProcessInfo::ProcessInfo()
    : _pcs_type(FiniteElement::INVALID_PROCESS),
      _pcs_pv(FiniteElement::INVALID_PV),
      _pcs(NULL),
      _temp_unit(FiniteElement::CELSIUS)
{
}

ProcessInfo::ProcessInfo(FiniteElement::ProcessType pcs_type,
...
void ProcessInfo::setProcessPrimaryVariable(
    FiniteElement::PrimaryVariable pcs_pv)
{
    _pcs_pv = pcs_pv;
}
