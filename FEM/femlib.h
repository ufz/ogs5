...
extern void CalcXDElementJacobiMatrix(long index,
                                      double r,
                                      double s,
                                      double t,
                                      double* vec,
...
extern void Calc3DElementJacobiMatrix(long number,
                                      double r,
                                      double s,
                                      double t,
                                      double* erg,
...
extern void Calc2DElementJacobiMatrixXY_9N(long index,
                                           double r,
                                           double s,
                                           double* invjac_t,
                                           double* dj);
extern void Calc3DElementJacobiMatrix_20N(long number,
                                          double r,
                                          double s,
                                          double t,
                                          double* erg,
                                          double* dj);
extern void CalcPrismElementJacobiMatrix(long number,
                                         double r,
                                         double s,
                                         double t,
                                         double* erg,
...
extern void IncorporateMatrix(long element,
                              double* left_matrix,
                              double* right_vector,
                              double* rechts);
#endif
