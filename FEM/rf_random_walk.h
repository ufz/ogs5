...
public:
    ...
    // Time
    double t;
    double StartingTime;  // JT 2010, added for continuous particle boundary,
                          // segemented by StartingTime
...
public:
    ...
    double randomMinusOneToOne(
        void);  // create uniform random number between -1 and 1
    double randomZeroToOne(
        void);  // create uniform random number between 0 and 1
    ...
    void GetDisplacement(Particle* B, double* Z, double* V, double* dD,
    ...
    int SolveForTwoIntersectionsInTheElement(Particle* A, double* p1,
                                             double* p2, int axis);
...
private:
    ...
    void CopyParticleCoordToArray(Particle* A, double* x1buff, double* x2buff,
                                  double* x3buff, double* x4buff);
    ...
    int G_intersect_line_segments(double ax1, double ay1, double ax2,
                                  double ay2, double bx1, double by1,
                                  double bx2, double by2, double* ra,
                                  double* rb, double* x, double* y);
    int G_intersect_line_segments_3D(double* pl1, double* pl2, double* pp1,
                                     double* pp2, double* pp3, double* pi);
