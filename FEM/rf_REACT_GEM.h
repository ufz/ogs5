...
public:
	...
	double *m_xDC, *m_gam, *m_xPH, *m_aPH, *m_vPS, *m_mPS, *m_bPS, *m_xPA, *m_dul, *m_dll, *m_bIC, *m_bIC_dummy, *m_rMB,
	    *m_uIC, *m_bSP;
	...
	*           4-dbr problem;
	...
	int flag_calculate_boundary_nodes; // set to zero to avoid precipitation/dissolution (porosity change) at boundary
	// nodes
	...
	double *m_xDC_buff, *m_xPH_buff, *m_aPH_buff, *m_xPA_buff, *m_excess_water_buff, *m_excess_gas_buff, *m_dul_buff,
	    *m_dll_buff, *m_Node_Volume_buff, *m_saturation_buff, *m_bIC_buff, *m_bIC_dummy_buff, *m_xDC_pts_buff,
	    *m_xDC_MT_delta_buff, *m_xDC_Chem_delta_buff;
...
// MPI implementation
	...
	unsigned int gem_nThread,
	    gem_nbar; // number of threads, number of threads + 1 (number of threads + master that have to cross a barrier)
