...
public:
	...
	FEMCondition(const std::string& geometry_name, FiniteElement::ProcessType pt = FiniteElement::INVALID_PROCESS,
	             FiniteElement::PrimaryVariable pv = FiniteElement::INVALID_PV, GEOLIB::GEOTYPE gt = GEOLIB::INVALID,
