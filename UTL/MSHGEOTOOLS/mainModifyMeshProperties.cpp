...
int main(int argc, char* argv[])
{
    ...
    {
        std::cout << "polyline for id " << polygon_id << " not found"
                  << std::endl;
        delete mesh;
        delete geo;
        return -1;
    ...
    if (!closed)
    {
        std::cout << "polyline with id " << polygon_id << " is not closed"
                  << std::endl;
        delete mesh;
        delete geo;
        return -1;
    ...
    {
        modify_mesh_nodes.substituteMaterialID(polygon, old_material_id,
                                               new_material_id);
    }
