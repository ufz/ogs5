...
//
//
// Author: Matthias Hess <matze@u-154-czaggh30.gpi.geowissenschaften.uni-tuebingen.de>, (C) 2006
//
...
#ifndef _WIN32
	start_ms = (double)start_val.tv_sec * 1000.0 + (double)start_val.tv_usec / 1000.0;
