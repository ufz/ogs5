                                                       ...
                                                       const double Point3[3])
{
    ...
    // << ", " << Point3[1] << ", " << Point3[2]; Calculate Lambda for Normal
    // equation of the plane (= scalar product of normal vector and one point of
    // the plane)
...
/*-------------------------------------------------------------------------
   ...
   EclipseBlock; Assumes at the moment regular hexahedron Return: nothing
   Programming: 09/2009 BG
   Modification:
   -------------------------------------------------------------------------*/
                                         ...
                                         const double Point4[3])
{
    ...
    // the gravitycentre for each triangle the gravity-centre of the
    // quadrilateral is the area weighted average of both centres of the
    // triangles
...
/*-------------------------------------------------------------------------
   ...
   the normal vector Return: nothing Programming: 09/2009 BG Modification:
   -------------------------------------------------------------------------*/
void CFaces::Calculate_components_of_a_vector(int flag,
                                              int phase_index,
                                              bool Radialmodell)
{
                        ...
                        MeshLib::CNode* Point4)
{
    ...
    // centre
    if (this->Calculate_FaceGravityCentre(
            coord_Point1, coord_Point2, coord_Point4, coord_Point3) == false)
        return false;
