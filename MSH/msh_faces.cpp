                                         ...
                                         const double Point4[3])
{
	...
	double a2 = 0.5 *
	            sqrt((vec_c[1] * vec_b[2] - vec_c[2] *
	                  vec_b[1]) * (vec_c[1] * vec_b[2] - vec_c[2] * vec_b[1])
	                 + (vec_c[2] * vec_b[0] - vec_c[0] *
	                    vec_b[2]) * (vec_c[2] * vec_b[0] - vec_c[0] * vec_b[2])
	                 + (vec_c[0] * vec_b[1] - vec_c[1] *
	                    vec_b[0]) * (vec_c[0] * vec_b[1] - vec_c[1] * vec_b[0]));
                        ...
                        MeshLib::CNode* Point4)
{
	...
	this->PlaneEquation->CalculatePlaneEquationFrom3Points(coord_Point1,
	                                                       coord_Point2,
	                                                       coord_Point3);
