...
double CElem::calcVolume () const
{
	...
	else if (this->geo_type == MshElemType::HEXAHEDRON)
	{
		...
		elemVolume += ComputeDetTex(nodes[5]->getData(),
		                            nodes[3]->getData(),
		...
		elemVolume += ComputeDetTex(nodes[1]->getData(),
		                            nodes[3]->getData(),
		                            nodes[5]->getData(), nodes[2]->getData());
		elemVolume += ComputeDetTex(nodes[3]->getData(),
		                            nodes[7]->getData(),
		                            nodes[5]->getData(), nodes[2]->getData());
		//kg44 reactivated
	}
	else if (this->geo_type == MshElemType::PRISM)
	{
		...
		elemVolume += ComputeDetTex(nodes[1]->getData(),
		                            nodes[4]->getData(),
		                            nodes[2]->getData(), nodes[3]->getData());
		elemVolume += ComputeDetTex(nodes[2]->getData(),
		                            nodes[4]->getData(),
