...
public:
	...
	std::vector<long>
	    connected_faces; // BG, 09/2010, necessary for coupling to Eclipse, index of faces where the node is part of it
	 ...
	 */
	double& operator[](size_t idx) { return const_cast<double&>(static_cast<const CNode&>(*this)[idx]); }
	...
	std::vector<size_t> const& getConnectedNodes() const { return _connected_nodes; }
	 ...
	 */
	bool isNonGhost(const size_t id_max_act_l, const size_t id_max_l, const size_t id_max_act_h)
	{
