...
### IAPWS model, freesteam
if (OGS_USE_FREESTEAM)
	find_package(FreeSteam REQUIRED QUIET)
	if (FREESTEAM_FOUND)
		include_directories( ${FREESTEAM_INCLUDE_DIR} )
		add_definitions(-DUSE_FREESTEAM)
	else()
		message(WARNING  "freesteam is not found. Please install it or set its path manually.")
		message(WARNING  "By default, freesteam is installed in /usr/local")
	endif()
endif()
